...
$query_Recbnb = "SELECT * FROM ad_show WHERE position = 'A' AND class = '144' ORDER BY rand() ASC LIMIT 10";
    ...
    <div class="rotator">
      <ul id="rotmenu">
        ...
        <li>
          ...
          <a href="<?php echo $row_Recbnb['banner_url']; ?>"><?php echo mb_substr($row_search['banner_title'],0,7,'utf-8'); ?></a>
      ...
      <div id="rot1">
        <img src="" alt="" width="100%" class="bg"/>
      </div>
    </div>
  </div>  
</div>
...
<script type="text/javascript" src="js/rotmenu.js"></script>
<?php
