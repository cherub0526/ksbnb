...
if(gettype($le2)!='int'){
	...
	$insertGoTo = "admin_banner_add_news.Classphp";
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
  <table width="821" border="0" cellpadding="1">
    <tr>
      <td colspan="2" class="cx_admin_table">廣告新聞分類整批新增</td>
      </tr>
    <tr>
      <td width="115" class="cx_admin_table">標題</td>
      <td width="690" class="cx_admin_table"><input type="text" name="title" id="title" /></td>
      </tr>
    <tr>
      <td class="cx_admin_table">商家</td>
      <td class="cx_admin_table"><input type="text" name="commerce" id="commerce" /></td>
      </tr>
    <tr>
      <td class="cx_admin_table">商家帳號</td>
      <td class="cx_admin_table"><input type="text" name="uname" id="uname" /></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="cx_admin_table"><input type="text" name="downdate" id="downdate" /></td>
      </tr>
    <tr>
      <td class="cx_admin_table">廣告連結</td>
      <td class="cx_admin_table"><input type="text" name="banner_url" id="banner_url" /></td>
      </tr>      
    <tr>
      ...
      <td class="cx_admin_table"><?php require_once("cx_position.php"); ?>  
        ...
        排序
        <input type="text" name="sorting" id="sorting" onkeypress="IsNum(event)" value="" /><input name="banner_type" type="hidden" id="banner_type" value="3" /></td>
    </tr>
    <tr>
      ...
      <td class="cx_admin_table">
        ...
        <label style="display:inline-block">
          <input type="checkbox" name="level2[]" value="核取方塊" id="level2_0" />
