...
mysql_select_db($database_ksnews3, $ksnews3);
$query_RecMember = "SELECT * FROM users WHERE level_group = 'member' ORDER BY user_id ASC";
...
mysql_select_db($database_ksnews3, $ksnews3);
$query_RecSearch = sprintf("SELECT * FROM users WHERE user LIKE %s AND level_group = 'member' ORDER BY user_id ASC", GetSQLValueString("%" . $colname_RecSearch . "%", "text"));
...
<div id="top_nav">
  <table width="835" border="0" cellpadding="0" cellspacing="0" height="28">
    <tr>
      ...
      <td width="100" background="../images/board04.gif" align="left" style="font-size:0.8em">一般會員 總覽</td>
      <td width="681" background="../images/board04.gif" style="font-size:0.8em"><form id="form1" name="form1" method="post" action="admin_member.php" target="frm">
      ...
      <?php do { ?>
          <?php if ($totalRows_RecSearch > 0) { // Show if recordset not empty ?>
            <tr>
              ...
              <td width="266"><?php echo $row_RecSearch['join_date']; ?></td>
              <td width="177"><a href="admin_userUpdate.php?id=<?php echo $row_RecSearch['user_id']; ?>">編輯</a> <a href="member_detail.php?delmember=true&amp;id=<?php echo $row_RecSearch['user_id']; ?>" target="frm">刪除</a></td>
            </tr>
