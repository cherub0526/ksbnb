...
mysql_select_db($database_ksnews3, $ksnews3);
$query_RecMember = "SELECT * FROM users WHERE level_group = 'vender' ORDER BY user_id ASC";
...
mysql_select_db($database_ksnews3, $ksnews3);
$query_RecSearch = sprintf("SELECT * FROM users WHERE user LIKE %s AND level_group = 'vender' ORDER BY user_id ASC", GetSQLValueString("%" . $colname_RecSearch . "%", "text"));
