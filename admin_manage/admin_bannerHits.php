...
if ((isset($_GET['id'])) && ($_GET['id'] != "") && (isset($_GET['delbanner']))) {
  ...
  $deleteGoTo = "admin_bannerHits.php";
...
mysql_select_db($database_ksnews3, $ksnews3);
$query_RecBanner = sprintf("SELECT * FROM banner ORDER BY banner_id DESC");
...
<div align="center" id="content">
    <table width="821" border="0" cellpadding="0">
      <tr bordercolor="#000066" >
        ...
        <td width="63" class="cx_admin_table"><div align="center">點擊次數</div></td>
...
do {  
?>
              <option value="<?php echo $row_RecZone['c_zone']?>"<?php if (!(strcmp($row_RecZone['c_zone'].(int)$row_RecZone['c_zip'], $row_RecBanner['banner_position'].$row_RecBanner['level']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecZone['c_name']?></option>
              <?php
...
?>
          ...
          <td class="cx_admin_table"><?php echo $row_RecBanner['count']; ?></td>
          <td class="cx_admin_table"><a href="admin_banner_update.php?id=<?php echo $row_RecBanner['banner_id'];?>">編輯</a> <a href="admin_bannerHits.php?delbanner=true&amp;id=<?php echo $row_RecBanner['banner_id']; ?>">刪除</a></td>
        </tr>
