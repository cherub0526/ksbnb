...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bnb_active (a_name, a_area, a_zip, a_date, a_text, a_images) VALUES (%s, %s, %s, %s, %s, %s)",
...
<body onload="createCKeditor('a_text','Full','office2003')">
...
<div id="top_nav">
  <table width="835" border="0" cellpadding="0" cellspacing="0" height="28">
    <tr>
      ...
      <td width="144" background="../images/board04.gif" align="left" style="font-size:0.8em">鄉鎮活動 新增 </td>
...
?>
        ...
        <input name="a_date" type="hidden" id="a_date" value="<?php echo date("Y-m-d H:i:s"); ?>" /></td>
      </tr>
      <tr>
        <td>活動內文：</td>
        <td><label for="a_text"></label>
        <textarea name="a_text" cols="50" rows="10" id="a_text"></textarea>
        </td>
      </tr>
      <tr>
