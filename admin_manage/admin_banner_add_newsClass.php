...
$array = array('title'=>'標題','commerce'=>'商家','uname'=>'商家帳號','update'=>'上架時間','downdate'=>'上架天數','level2'=>'區塊','sorting'=>'排序','banner_type'=>'型態');
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$insertGoTo = "admin_banner_add_newsClass.php";
	}
  ...
  <table width="821" border="0" cellpadding="1">
    ...
    <tr>
      ...
      <td class="cx_admin_table"><?php //require_once("cx_position.php"); ?>  
        ...
        排序
        <input type="text" name="sorting" id="sorting" onkeypress="IsNum(event)" value="<?php echo $_POST['sorting'];?>" /><input name="banner_type" type="hidden" id="banner_type" value="3" /></td>
    </tr>
    <tr>
