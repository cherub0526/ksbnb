...
if(gettype($le2)!='int'){
	...
	$insertGoTo = "admin_banner_add.php";
...
<div id="content">
  <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
    <table width="821" border="0" cellpadding="1">
      <tr>
        <td width="115" class="cx_admin_table">新增 圖像 廣告</td>
      ...
      <tr>
        ...
        <td class="cx_admin_table"><input name="downdate" type="text" id="downdate" value="<?php echo $_POST['downdate'];?>"  /></td>
      </tr>
      <tr>
...
<td class="cx_admin_table"><input type="text" name="banner_url" id="banner_url" value="<?php echo $_POST['banner_url'];?>"  /></td>
      ...
      <tr>
        ...
        <td class="cx_admin_table">
          ...
          排序
  <input type="text" name="sorting" id="sorting" onkeypress="IsNum(event)" value="<?php echo $_POST['sorting'];?>" /><input name="banner_type" type="hidden" id="banner_type" value="1" /></td>
      </tr>
      <tr>
...
<?php
//mysql_free_result($banner_position);
?>
