...
$maxStringLength = 4;						//Maximum length of the captcha string.
...
$captchaCharacters = "abcdefghijklmnopqrstuvwxyz23456789";
$caseSensitive = false;						//Make the captcha string case-sensitive.

$minFontSize = 50;							//The minimum font size in points.
$maxFontSize = 50;							//The maximum font size in points.
