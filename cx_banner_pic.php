...
<div class="slider-wrapper">    
    <div class="slider">
      <ul class="items">        
        ...
        <li> <img src="timthumb.php?src=images/ksad/<?php echo $row_RecSearchBanner['banner_pic2']; ?>&w=1000" alt="" /></li>   
        <?php } else { ?>   
        <li> <img src="timthumb.php?src=images/ksad/<?php echo $row_RecSearchBanner['banner_pic']; ?>&w=1000" alt="" /></li>   
        <?php } ?>
      </ul>
    </div>
</div>
