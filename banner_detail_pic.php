...
if ((isset($_GET['hits'])) && ($_GET['hits'] != "")) {
  ...
  setcookie('banner',$_SERVER['REMOTE_ADDR'],time()+5);//設定 cookie 避免用戶衝點擊數(單位：秒)
  }
  $execGoTo = "banner_detail_pic.php?id=".$_GET['id'];
...
<body>
  <div id="body">
    ...
    <div id="cx_content">
      ...
      <!-- 中區塊 -->
      <div id="cx_middle1" style="width:100%">
          <div id="cx_m_top">
            <?php include_once("cx_banner_pic.php");?>
        </div>
