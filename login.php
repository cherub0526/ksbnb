...
//  if(!isset($sum)){$sum=1;}
 ...
 // GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   ...
   $LoginRS__query=sprintf("SELECT user, pass, level FROM users WHERE user=%s AND pass=%s",
   GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
...
<?php 
	...
	{
		header("Location:admin_manage/admin_ksbnb.php");
	}
?>
...
<div id="login">
<form ACTION="<?php echo $loginFormAction; ?>" method="POST" name="memberLogin" id="memberLogin" >
<table width="990" border="0" cellspacing="5" cellpadding="5">
  ...
  <tr>
    ...
    <td colspan="2" rowspan="2"><?php $captcha = new CaptchaImage(150,50,5,'CCCCCC','0033FF','00FFFF');?>
      <input name="captcha" type="text" id="captcha" value="<?php echo $_SESSION['captcha_code']; ?>" size="10" />
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center"><a href="memberAdd.php">會員註冊</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
